...
<div class="main-container">
    ...
    <?php
        ...
        $query_search = "SELECT a.* FROM ads a JOIN categories c ON a.adcategory = c.categoryid where c.catname = 'Decor' and a.status = 1";
        ...
        if (isset($_GET['search'])) {
            ...
            $sql_code = $sql_code = "SELECT a.* from ads a INNER JOIN categories c ON a.adcategory = c.categoryid where c.catname = 'Decor' AND a.adtitle LIKE '%$searching%'";
