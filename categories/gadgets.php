...
<div class="main-container">
    ...
    <?php
        ...
        $query_search = "SELECT a.* FROM ads a JOIN categories c ON a.adcategory = c.categoryid where c.catname = 'Gadgets' and a.status = 1";
        ...
        if (isset($_GET['search'])) {
            ...
            $sql_code = $sql_code = "SELECT a.* from ads a INNER JOIN categories c ON a.adcategory = c.categoryid where c.catname = 'Gadgets' AND a.adtitle LIKE '%$searching%'";
