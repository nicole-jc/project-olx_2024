...
<body>
    ...
    <div class="left-section">
        <p><a href="../main/main.php"><img src="../resources/melodyfull.png" style="width: 50px; height: 50px;"></a></p>
    </div>
    ...
    <div class="right_section">
        ...
        <ul>
            ...
            if (isset($_SESSION["user-name"])) {
                ...
                echo '<li><a href="../main/login.php"><img src="../resources/login.png" style="width: 35px; height: 35px;"></a></li>';
            }
            ?>
...
<aside>
    <nav>
    <ul>
        <li><a href="../main/main.php"><img src="../resources/home.png" style="width: 38px; height: 38px; margin-left: 6px; margin-top: 100px;"></a></li>
        <?php
if(isset($_SESSION["user-name"])){
    if($_SESSION["hierarchy"] == 1){
        echo '<li><a href="../main/adm.php"><img src="../resources/check.png" style="width: 38px; height: 38px; margin-top: 18px; margin-left: 6px;"></a></li>';
       
    } else {
        echo '<li><a href="../main/changeinfo.php"><img src="../resources/settingss.png" style="width: 38px; height: 38px; margin-top: 18px; margin-left: 5px;"></a></li>';
    } 
    } else {
        echo '<li><a href="../main/changeinfo.php"><img src="../resources/settingss.png" style="width: 38px; height: 38px; margin-top: 18px; margin-left: 5px;"></a></li>';  
...
?>
        <li><a href="../main/create_ad.php"><img src="../resources/add.png" style="width: 38px; height: 38px; margin-top: 18px; margin-left: 5px;"></a></li>
        <li><a href="../main/bag.php"><img src="../resources/bags.png" style="width: 38px; height: 38px; margin-top: 18px; margin-left: 5px;"></a></li>
        <li><a href="../main/wishlist.php"><img src="../resources/favourite.png" style="width: 38px; height: 38px; margin-top: 18px; margin-left: 5px;"></a></li>
        <?php
        if(isset($_SESSION["user-name"])){
            echo '<li><a href="../main/logout.php"><img src="../resources/logout.png" style="width: 38px; height: 38px; margin-top: 18px; margin-left: 8px;"></a></li>';
        }
?>
        </ul>
    </nav>
...
<div class="main-container">
    ...
    <div class="dropdown-menu">
        ...
        <div class="drop-categories">
           ...
           <a href="eletronic.php">Eletronic</a>
    ...
    <?php
        ...
        $query_search = "SELECT a.* FROM ads a JOIN categories c ON a.adcategory = c.categoryid where c.catname = 'Tech Accessories' and a.status = 1";
        ...
        if (isset($_GET['search'])) {
            ...
            $sql_code = $sql_code = "SELECT a.* from ads a INNER JOIN categories c ON a.adcategory = c.categoryid where c.catname = 'Accessories' AND a.adtitle LIKE '%$searching%'";
        ...
        if (mysqli_num_rows($result_search) > 0) {
            while ($row_ad = mysqli_fetch_assoc($result_search)) {
                echo '<a href="../main/ad.php?id=' . $row_ad['ad_id'] . '" class="ad-link">';
