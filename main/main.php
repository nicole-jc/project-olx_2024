...
<div class="main-container">
    ...
    <div class="dropdown-menu">
        ...
        <div class="drop-categories">
           <a href="../categories/decor.php">Decor</a>
           <a href="../categories/home.php">Home</a>
           <a href="../categories/retro.php">Retro</a>
           <a href="../categories/toys.php">Toys</a>
           <a href="../categories/eletronic.php">Eletronic</a>
           <a href="../categories/accessories.php">Accessories</a>
           <a href="../categories/gadgets.php">Gadgets</a>
        </div>
    </div>
    <div class="adsection">
    <h4>All ads</h4>
    ...
    <?php
        ...
        $query_search = "SELECT * FROM ads WHERE status = 1";
