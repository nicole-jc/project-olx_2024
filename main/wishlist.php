...
<!DOCTYPE html>
<head>
    <title><?php echo htmlspecialchars($_SESSION["user-name"]);?>'s wishlist</title>
...
<div class="main-container">
    ...
    <?php
        ...
        $query_search = "SELECT a.* FROM wishlist w INNER JOIN ads a ON w.ad_id = a.ad_id WHERE w.user_id = '$user_logged'";
        ...
        if (mysqli_num_rows($result_search) > 0) {
            ...
            echo '<p style="color: white;">Your wishlist is empty .</p>';
        }
    ?>
</div>
</div>
